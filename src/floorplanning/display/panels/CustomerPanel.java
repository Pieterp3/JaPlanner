...
public class CustomerPanel extends Panel {
	...
	public void handleAction(String command) {
		...
		if (command.startsWith("select")) {
			...
			Customer c = homePanel.getManager().getCustomer(name);
			informationLabels[0].setAttribute("text", "Name " + c.getName());
			informationLabels[1].setAttribute("text", "Address " + c.getAddress());
			informationLabels[2].setAttribute("text", "Phone Number " + c.getPhoneNumber());
			informationLabels[3].setAttribute("text", "Email " + c.getEmail());
			informationLabels[4].setAttribute("text", "Notes " + c.getNotes());
			informationLabels[5].setAttribute("text", "Estimates " + c.getEstimates().size());
		}
	}
