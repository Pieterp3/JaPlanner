...
public abstract class CombatSystemManager {
	 ...
	 * 
	 * Should be used to handle drops, exp, etc..
	 * 
	 * @param killed the entity that was killed
	 */
	protected abstract void processKill(LiveEntity killed);
	...
	public void setEntity(LiveEntity entity) {
		...
		this.killLog = new KillLog(entity);
	...
	public void logKill(LiveEntity e) {
		killLog.addKill(e);
		processKill(e);
	}
